...
map_range <- function(x,
                      ...
                      out_start = 0,
                      out_end = 1) {
    # Map a vector from one range to another. Works by first scaling down to
    # [0;1] and then scaling up to the target range.
    # Attention: Does not throw an error if out_start > out_end because this may
